                ...
                <div className="flex-1 px-3 bg-white divide-y space-y-1">
                  <ul className="space-y-2 pb-2">
                    ...
                    <li>
                      ...
                      >
                        <CircleStackIcon className="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75"></CircleStackIcon>
                    ...
                    <li>
                      <a
                        ...
                        className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group "
                      >
                        <CurrencyDollarIcon className="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75" />
                    ...
                    <li>
                      <a
                        ...
                        className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group "
                      >
                        <PlusIcon className="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75" />
                        <span className="ml-3 flex-1 whitespace-nowrap">
                          Add Item
                        </span>
                      </a>
                  ...
                  <div className="space-y-2 pt-2">
                    ...
                    >
                      ...
                      <span className="ml-3">System Check</span>
                    </a>
                  </div>
                </div>
              </div>
                  ...
                  <div className="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8  2xl:col-span-2">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex-shrink-0">
                        <span className="text-2xl sm:text-3xl leading-none font-thin text-zinc-900">
                          Manage Tags
                        </span>
                        <h3 className="text-base font-normal text-gray-500">
                          Add, remove or assign tags
                        </h3>
                      </div>
                      <div className="flex flex-col items-center space-x-1 justify-end flex-1  text-base">
                        <div className="text-green-500 w-full flex flex-row justify-end space-x-1">
                          <CheckBadgeIcon className="w-5 h-5 pt-1"></CheckBadgeIcon>
                          <label> 50 Active Tags</label>
                        </div>
                      </div>
                    </div>
                    <div id="main-chart">
                      <div className="mt-2">
                        <div className="md:flex md:items-center md:-mx-2 flex justify-end">
                          <input
                            placeholder="TagID"
                            className="flex justify-center w-full px-6 py-3 text-gray-500 border border-gray-500 rounded-md md:mt-0 md:w-auto md:mx-2 dark:gray-blue-400 dark:text-gray-400 focus:outline-none"
                          ></input>
                          <button className="flex items-center justify-between px-6 py-3 text-sm tracking-wide text-white capitalize transition-colors duration-300 transform bg-green-500 rounded-md hover:bg-green-400 focus:outline-none focus:ring focus:ring-green-300 focus:ring-opacity-50">
                            <span>Add</span>
                ...
                <div className="mt-4 w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                  ...
                  <div className="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                    <div className="flex items-center">
                      ...
                      <div className="ml-5 w-0 flex items-center justify-end flex-1 text-rose-500 text-base font-bold">
                  ...
                  <div className="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                    <div className="flex items-center">
                      ...
                      <div className="ml-5 w-0 flex items-center justify-end flex-1 text-orange-500 text-base font-bold">
